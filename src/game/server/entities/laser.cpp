...
bool CLaser::HitCharacter(vec2 From, vec2 To)
{
	...
	if (m_Type == WEAPON_SHOTGUN)
	{
		...
		if (pOwnerChar->GetPlayer()->m_QuestInSession && pOwnerChar->GetPlayer()->m_QuestPart == CPlayer::QUEST_PART2 && pHit->GetPlayer()->GetCID() == pOwnerChar->GetPlayer()->m_RandomID)
		{
			pOwnerChar->m_QuestData.m_ShotgunedTarget = true;
			pOwnerChar->GetPlayer()->m_RandomID = -1;
		}
	}

...
CSpecial1::CSpecial1(CGameWorld *pGameWorld, vec2 Pos, int Owner)
...
void CSpecial1::Reset()
{
	GameServer()->m_World.DestroyEntity(this);
}

void CSpecial1::Gravity()
{
...
void CSpecial1::Tick()
{
	...
	{
		Reset();
		if(pOwnerChar && pOwnerChar->IsAlive() && pOwnerChar->GetPlayer() && pOwnerChar->GetPlayer()->m_Special1 > 0) /* Item Value */
			pOwnerChar->GetPlayer()->m_Special1--;
	}
}

void CSpecial1::Snap(int SnappingClient)
{
